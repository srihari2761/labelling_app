...
const commands = {
  start: () => Promise.resolve(require('./cli-chunk5.js')),
  dev: () => Promise.resolve(require('./cli-chunk6.js')),
  build: () => Promise.resolve(require('./cli-chunk7.js')),
  generate: () => Promise.resolve(require('./cli-chunk8.js')),
  help: () => Promise.resolve(require('./cli-chunk9.js'))
};
